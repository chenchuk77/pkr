...
function internal_GetCardImageUrl (card) {
  ...
  return "url('js-css-poker/images/" + rank + '_of_' + suit + ".png')";
}
...
function internal_setCard (diva, card) {
  ...
  if (typeof card == 'undefined' || card == "") {
    image = "url('js-css-poker/images/outline.gif')";
  } else if (card == "blinded") {
    image = "url('js-css-poker/images/cardback.png')";
  } else {
...
function gui_initialize_css () {
  ...
  image = "url('js-css-poker/images/poker_table.png')";
