...
public class ConsoleSmartClient extends WebSocketClient implements PlayerStrategy {
...
//    }
    ...
    public ConsoleSmartClient(URI serverURI) {
        super( serverURI );
        initHand();
    }
...
//            System.out.println( "got cards. player.getStrHole2()=" +player.getStrHole2() );
            ...
            strHole1 = player.getStrHole1();
            strHole2 = player.getStrHole2();
            holeCards = strHole1 + strHole2;

            System.out.println( "ctx cards updated." );
            System.out.println( "******* got cards: " +holeCards+"." );

            System.out.println( "******* is pair: " + Utils.isPair(holeCards));
            System.out.println( "******* is suited: " + Utils.isSuited(holeCards));
...
//        Scanner scanner = new Scanner(System.in);
        System.out.println("automatic player (class:" + this.getClass().getSimpleName() + ")");
        System.out.println("valid commands: " + validOptions.toString());
        System.out.println("valid amounts: " + optionAmounts.toString());
...
//        String username = args[0].split(",")[1];
        ...
        ConsoleSmartClient c = new ConsoleSmartClient( new URI( "ws://localhost:4444" )); // more about drafts here: http://github.com/TooTallNate/Java-WebSocket/wiki/Drafts
