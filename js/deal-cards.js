...
function start(){
	...
	setTimeout(function() { deal(c1, s1, {x: 400, y: 400}, {x: 400, y: 200}, {x: 600, y: 100})}, 0);
	setTimeout(function() { deal(c2, s2, {x: 400, y: 400}, {x: 370, y: 150}, {x: 300, y: 100})}, 200);
	setTimeout(function() { deal(c3, s3, {x: 400, y: 400}, {x: 170, y: 150}, {x: 100, y: 100})}, 400);
	setTimeout(function() { deal(c12, s4, {x: 400, y: 400}, {x: 420, y: 200}, {x: 650, y: 100})}, 600);
	setTimeout(function() { deal(c22, s5, {x: 400, y: 400}, {x: 400, y: 150}, {x: 350, y: 100})}, 800);
	setTimeout(function() { deal(c32, s6, {x: 400, y: 400}, {x: 220, y: 150}, {x: 150, y: 100})}, 1000);
	setTimeout(function() { 
